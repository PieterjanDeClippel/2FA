...
namespace AuthenticatorTest2.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new AuthenticatorTest2.Models.ApplicationUser { UserName = model.Email, Email = model.Email };
